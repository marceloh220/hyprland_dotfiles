...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠑⠤⣀⣀⠔⠁⠋⠭⠯⠭⠧⠭⠶⠤⠄⠀⠀ 
    ...
    line_counting = 0
    msg_list, msg_len = split_msg(msg)
...
def dinamic_split_msg(msg):
    # Ainda descobrindo o que fazer com isso
    msg_list = []
    ...
    return msg_list, msg_parts, msg_size
